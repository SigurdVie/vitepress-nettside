// node_modules/@cynber/vitepress-valence/dist/photoswipe-lightbox.esm-BjTq-zOm.js
function d(n, t, i) {
...
var S = class {
   ...
   */
  constructor(t, i) {
    if (this.element = d("pswp__img pswp__img--placeholder", t ? "img" : "div", i), t) {
      const e = (
...
var I = class {
  ...
  load(t, i) {
    ...
    this.element && !i || this.instance.dispatch("contentLoad", {
      content: this,
      isLazy: t
    }).defaultPrevented || (this.isImageContent() ? (this.element = d("pswp__img", "img"), this.displayedImageWidth && this.loadImage(t)) : (this.element = d("pswp__content", "div"), this.element.innerHTML = this.data.html || ""), i && this.slide && this.slide.updateContentSize(true));
  }
  /**
   * Preload image
   *
  ...
  displayError() {
    if (this.slide) {
      var t, i;
      let e = d("pswp__error-msg", "div");
      e.innerText = (t = (i = this.instance.options) === null || i === void 0 ? void 0 : i.errorMsg) !== null && t !== void 0 ? t : "", e = /** @type {HTMLDivElement} */
      this.instance.applyFilters("contentErrorElement", e, this), this.element = d("pswp__content pswp__error-msg-container", "div"), this.element.appendChild(e), this.slide.container.innerText = "", this.slide.container.appendChild(this.element), this.slide.updateContentSize(true), this.removePlaceholder();
    }
  }
  /**
   * Append the content
...
var A = class extends E {
  ...
  _getGalleryDOMElements(t) {
    var i, e;
    return (i = this.options) !== null && i !== void 0 && i.children || (e = this.options) !== null && e !== void 0 && e.childSelector ? o(this.options.children, this.options.childSelector, t) || [] : [t];
  }
  /**
...
var z = class extends A {
  ...
  loadAndOpen(t, i, e) {
    ...
    if (!i && this.options.gallery && this.options.children) {
      const s = o(this.options.gallery);
      s[0] && (i = {
        gallery: s[0]
      });
    }
  ...
  destroy() {
    var t;
    (t = this.pswp) === null || t === void 0 || t.destroy(), this.shouldOpen = false, this._listeners = {}, o(this.options.gallery, this.options.gallerySelector).forEach((i) => {
...
@cynber/vitepress-valence/dist/photoswipe-lightbox.esm-BjTq-zOm.js:
  (*!
    * PhotoSwipe Lightbox 5.4.4 - https://photoswipe.com
    * (c) 2024 Dmytro Semenov
    *)
*/
//# sourceMappingURL=photoswipe-lightbox.esm-BjTq-zOm-4N3YVDH5.js.map
