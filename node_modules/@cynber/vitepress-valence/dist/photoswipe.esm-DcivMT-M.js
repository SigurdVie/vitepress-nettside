...
class et {
  ...
  change() {
    ...
    if (this.pswp.animations.stopAll(), e.isShifted()) {
      ...
      t.x < -0.5 && o < 0 || t.x < 0.1 && o < -0.5 ? (s = 1, t.x = Math.min(t.x, 0)) : (t.x > J && o > 0 || t.x > -0.1 && o > 0.5) && (s = -1, t.x = Math.max(t.x, 0)), e.moveIndexBy(s, !0, t.x);
    }
...
class zt {
  ...
  init() {
    ...
    this.isRegistered = !1, this.uiElementsData = [At, It, bt, Lt, Ct, Tt], t.dispatch("uiRegister"), this.uiElementsData.sort((e, i) => (e.order || 0) - (i.order || 0)), this.items = [], this.isRegistered = !0, this.uiElementsData.forEach((e) => {
...
class $t extends Ht {
  ...
  refreshSlideContent(t) {
    this.contentLoader.removeByIndex(t), this.mainScroll.itemHolders.forEach((e, i) => {
      ...
      if (this.canLoop() && (o = this.getLoopedIndex(o)), o === t && (this.setContent(e, t, !0), i === 1)) {
        var a;
